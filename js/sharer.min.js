    ...
    a.prototype = {
        ...
        urlSharer: function (e) {
            var a, r = e.params || {},
                s = Object.keys(r),
                i = s.length > 0 ? "?" : "";
            for (a = 0; a < s.length; a++) "?" !== i && (i += "&"), r[s[a]] && (i += s[a] + "=" + encodeURIComponent(r[s[a]]));
            if (e.shareUrl += i, e.isLink) t.location.href = e.shareUrl;
            else {
                var l = e.width || 600,
                    h = e.height || 480,
                    u = t.innerWidth / 2 - l / 2 + t.screenX,
                    g = t.innerHeight / 2 - h / 2 + t.screenY,
                    o = "scrollbars=no, width=" + l + ", height=" + h + ", top=" + g + ", left=" + u,
        ...
        var r, s = e.querySelectorAll(".sharer"),
            i = s.length;
        for (r = 0; i > r; r++) s[r].addEventListener("click", t)
    })
}(window, document);